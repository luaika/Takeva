        ...
        <div class="col-md-8">
            <div class="card fondoFormulario" >
                <div class="modal-header encabezadoFormulario mb-3" >
                    <h4 class="modal-title text-white" id="exampleModalLabel" style="text-align: center;" ><?php echo e(__('Restablecer Contraseña')); ?></h5>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Estefania\Documents\PROYECTO TAKEVA\Takeva\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>